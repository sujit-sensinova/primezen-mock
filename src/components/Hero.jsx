        ...
        <div className="max-w-7xl w-full mx-auto px-6 relative z-10 pt-20">
          <div className="max-w-3xl">
            ...
            <motion.div
              ...
              initial="hidden"
              animate="visible"
              className="mb-8 mix-blend-difference text-white"
            >
              ...
              <div className="overflow-hidden flex flex-wrap gap-x-4">
                {["Mood", "Prime."].map((word, i) => (
                  <motion.span 
                    key={i}
                    variants={wordVariants}
                    className={`title-font text-[clamp(2.5rem,7.2vw,5.85rem)] font-bold tracking-tighter leading-[0.9] ${word === 'Prime.' ? 'text-[#ff3333]' : ''}`}
            ...
            <motion.div
              ...
              className="h-[3px] bg-brand mb-8 mix-blend-difference"
            />
            ...
            <motion.p 
              ...
              className="text-lg md:text-xl mb-12 leading-relaxed max-w-xl mix-blend-difference text-white/90"
            >
